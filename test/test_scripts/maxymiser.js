...
if(!window.mmcore){
	...
	server:'cg-global.maxymiser.com/v5/',
	cookie_domain:'',
	tpixel:false,
	cprefix:'mmcore.',
	inline_state:true,
	...
	SetAction:function(name,val,attr){var _t=this;_t._vars.act['a'+(_t._act_id++)+'_'+_t._T(name)]=''+_t._ToNum(0,val)+','+(escape(attr)||'')},
	$Action:function(){var _t=this,a=_t.GetCookie("mmact",1)+_t._S(arguments);_t.SetCookie("mmact",a,1,1)},
	SetPersCriterion:function(name,val){this._vars.uat[this._T(name)]=(escape(val)||'')},
	...
	SetVisitorID:function(id,idtype){var t=this,_i=idtype;if(!_i)_i=1;t._vars.ids[_i]=escape(id)},
...
//transport
	...
	_rt:1000,
//private
	jsver:'5.9',_vars:{fv:{},act:{},uat:{},ids:{}},_act_id:0,_vars_alias:{act:'uv'},_renderers:{},_extensions:{},_r_mbs:{},
	...
	_Init:function(first){
		...
		if (typeof _r!='undefined'&&_r!=''&&_t._ValByKey(_r.split('?')[1],'pt.enabled','=','&')=='1') 
